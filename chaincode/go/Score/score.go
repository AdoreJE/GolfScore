...
func (s *SmartContract) StartGame(ctx contractapi.TransactionContextInterface, groundID, user1, user2, user3, user4 string) error {
	...
	GameCompositeKey, _ := ctx.GetStub().CreateCompositeKey("game", []string{groundID, user1, user2, user3, user4, gameNumber})
...
func (s *SmartContract) QueryGameInfo(ctx contractapi.TransactionContextInterface, groundID, user1, user2, user3, user4, gameNumber string) (*GameInfo, error) {
